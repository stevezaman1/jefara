...
export default function LandingPage({ onGetStarted, onSignIn, onLaunchDemo, onSandboxSuccess }: LandingPageProps) {
        ...
        <header className="border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-40 transition-all duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center space-x-2 cursor-pointer" onClick={() => setBookingConfirmed(false)}>
              ...
              <span className="font-sans font-semibold text-base tracking-tight text-[#7c3aed]">Jefara</span>
            </div>
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-violet-100 selection:text-violet-900 relative overflow-x-hidden">
      ...
      <div className="absolute top-0 inset-x-0 h-[1000px] bg-gradient-to-b from-violet-500/[0.11] via-violet-500/[0.02] to-transparent pointer-events-none -z-10" />
      <div className="absolute top-[20%] right-0 w-[400px] h-[400px] rounded-full bg-violet-100/15 blur-[120px] pointer-events-none -z-10" />
      <div className="absolute top-[45%] left-[-100px] w-[500px] h-[500px] rounded-full bg-violet-50/15 blur-[130px] pointer-events-none -z-10" />
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
            ...
            >
              ...
              <div className="flex-shrink-0">
                <span className="font-sans font-semibold text-lg sm:text-xl md:text-2xl tracking-tight text-[#7c3aed]">Jefara</span>
              </div>
            </button>
          </div>
      ...
      {!showProductTour ? (
        <>
          {/* Hero Section */}
          <section className="relative w-full bg-transparent pt-24 pb-8 md:pt-28 md:pb-12 px-4 sm:px-6 md:px-8 overflow-hidden">
            <div className="max-w-7xl mx-auto bg-gradient-to-b from-violet-500/[0.11] via-violet-500/[0.02] to-white rounded-[2rem] md:rounded-[2.5rem] border border-violet-100/30 pt-16 pb-16 px-4 sm:px-8 md:pt-24 md:pb-24 md:px-12 relative overflow-hidden flex flex-col items-center text-center shadow-xs">
              {/* Soft ambient violet glow at the bottom of the hero ground */}
              <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-violet-300/30 blur-[120px] pointer-events-none rounded-full -z-10" />
        ...
        <motion.h1 
          ...
          className="text-[18px] sm:text-[21px] md:text-[29px] font-display font-extrabold tracking-tight text-slate-950 max-w-md sm:max-w-xl md:max-w-2xl leading-[1.15] md:leading-[1.1] mx-auto text-center"
        >
